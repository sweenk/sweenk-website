  ...
  return (
    <Layout title="Privacy Policy">
      ...
      <p>
        ...
        Service using the following authentication methods:
      </p>
      <ul>
        <li>Phone Number</li>
        <li>Email Address</li>
      ...
      <p>
        If You decide to register using your phone number or email address, We
        may collect the respective data provided. This might include your phone
        number, email address, and any other information you choose to share
        during the registration process.
      </p>
      <p>
        You may also have the option of sharing additional information with the
        Company during registration or otherwise. If You choose to provide such
        information and Personal Data, You are giving the Company permission to
